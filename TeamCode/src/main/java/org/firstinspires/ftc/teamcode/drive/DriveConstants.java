...
public class DriveConstants {
    ...
    // We use Gobilda 5201s
    public static final double TICKS_PER_REV = 1497.325; // I believe TICKS_PER_REV is encoder resolution ("Encoder Cycles Per Revolution" as listed in gobilda website), but I could be wrong
     ...
     */
    public static final boolean RUN_USING_ENCODER = true; // they probably are broken but we should really use them
